        ...
        <div class="col-md-12">
            <div class="row align-items-center">
                <div class="col-md-6 header-left">
                    <a href="../../../churrascaria/admin.php" class="logo-link">
                        <img src="../../../../churrascaria/img/download.png" class="logo-img" alt="Pampa Grill">
                    </a>
                    <h2 class="header-title">Pampa Grill</h2>
                </div>
                <div class="col-md-6 header-right">
                    <button type="button" class="btn custom-btn"><a href="../../../churrascaria/naosei.php" class="btn-link">Pedidos</a></button>
                    <button type="button" class="btn custom-btn"><a href="../../../churrascaria/add.php" class="btn-link">Adicionar Produto</a></button>
                    <button type="button" class="btn custom-btn"><a href="../../../churrascaria/exc.php" class="btn-link">Excluir Produto</a></button>
