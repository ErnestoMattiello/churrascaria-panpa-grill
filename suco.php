...
<head>
    ...
    <link rel="stylesheet" href="css/suco.css"> <!-- Atualizado para a pasta css -->
...
<style>
    ...
    <div class="container">
        <h1 class="text-center" style="color: white">Nossos Sucos</h1>
        <div id="customers-testimonials" class="owl-carousel">
            <!-- Testemunho 1 -->
            <div class="item">
                <div class="shadow-effect">
                    <img class="img-responsive" src="img/laranja.jpg" alt="Picanha">
                    <div class="item-details">
                        <h5>Suco de Laranja Natural <span style="color: black">R$ 8,00</span></h5>
                        <p>Sua doçura e leve acidez proporcionam um sabor delicioso e revigorante, ideal para começar o dia ou acompanhar o almoço.</p>
                    </div>
                </div>
            </div>
            <!-- Testemunho 2 -->
            <div class="item">
                <div class="shadow-effect">
                    <img class="img-responsive" src="img/abacaxi.jpeg" alt="Fraldinha">
                    <div class="item-details">
                        <h5>Suco de Abacaxi com Hortelã <span style="color: black">R$ 9,00</span></h5>
                        <p>Combina a doçura do abacaxi e o frescor da hortelã, criando uma bebida leve, refrescante e revigorante, perfeita para os dias quentes.</p>
                    </div>
                </div>
            </div>
            <!-- Testemunho 3 -->
            <div class="item">
                <div class="shadow-effect">
                    <img class="img-responsive" src="img/limao.jpg" alt="Alcatra">
                    <div class="item-details">
                        <h5>Suco de Limão com Hortelã <span style="color: black">R$ 9,00</span></h5>
                        <p>Perfeito para hidratar e refrescar, é uma bebida leve e revigorante, ideal para qualquer ocasião. Uma opção que traz o equilíbrio perfeito entre refrescância e sabor.</p>
                    </div>
                </div>
            </div>
            <!-- Testemunho 4 -->
            <div class="item">
                <div class="shadow-effect">
                    <img class="img-responsive" src="img/melancia2.jpg" alt="Maminha">
                    <div class="item-details">
                        <h5>Suco de Melancia <span style="color: black">R$ 7,00</span></h5>
                        <p>O suco de melancia é feito com melancia fresca, sem conservantes ou açúcares, oferecendo hidratação natural e um sabor doce e suave. Uma opção saudável e refrescante para qualquer ocasião.</p>
                    </div>
                </div>
            </div>
            </div> <br>
