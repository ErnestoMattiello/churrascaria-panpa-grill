...
<head>
    ...
    <link rel="stylesheet" href="css/refri.css"> <!-- Atualizado para a pasta css -->
        ...
        <div id="customers-testimonials" class="owl-carousel">
            ...
            <div class="item">
                <div class="shadow-effect">
                    <img class="img-responsive" src="img/coca.webp" alt="Picanha">
                    <div class="item-details">
                        <h5>Coca Cola Normal e Zero KS <span style="color: black">R$ 7,50</span></h5>
                        <p></p>
                    </div>
                </div>
            </div>
            ...
            <div class="item">
                <div class="shadow-effect">
                    <img class="img-responsive" src="img/guarana2.jpg" alt="Fraldinha">
                    <div class="item-details">
                        <h5>Guaraná Antartica KS <span style="color: black">R$ 6,50</span></h5>
                        <p></p>
                    </div>
                </div>
            </div>
            ...
            <div class="item">
                <div class="shadow-effect">
                    <img class="img-responsive" src="img/pepsi2.jpeg" alt="Alcatra">
                    <div class="item-details">
                        <h5>Pepsi KS <span style="color: black">R$ 7,50</span></h5>
                        <p></p>
                    </div>
                </div>
            </div>
            ...
            <div class="item">
                <div class="shadow-effect">
                    <img class="img-responsive" src="img/fanta2.jpg" alt="Maminha">
                    <div class="item-details">
                        <h5>Fanta Laranja KS <span style="color: black">R$ 6,50</span></h5>
                        <p></p>
                    </div>
                </div>
            </div>
            ...
            <div class="item">
                <div class="shadow-effect">
                    <img class="img-responsive" src="img/sprite2.jpg" alt="Frango Grelhado">
                    <div class="item-details">
                        <h5>Sprite KS <span style="color: black">R$ 6,50</span></h5>
                        <p></p>
                    </div>
                </div>
            </div>
