...
<body>
    ...
    <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
      ...
      <li><a class="dropdown-item" href="index.php">Home</a></li>
                    ...
                    <button type="button" class="btn custom-btn"><a href="../../../churrascaria/login.php" class="btn-link">Pedido</a></button>
                    <button type="button" class="btn custom-btn"><a href="../../../churrascaria/login.php" class="btn-link">Reserva</a></button>
